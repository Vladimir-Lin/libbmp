...
cmake -G %VC_CMAKE% %STARDATE% -DCMAKE_INSTALL_PREFIX=%COMPILEPATH%\%TARGET% -DCMAKE_CONFIGURATION_TYPES=%BTYPE% -DCMAKE_BUILD_TYPE=%BTYPE% -DBUILD_SHARED_LIBS=%DOSHARED%
